...
time: "15:30",
text: `You realise that your team hasn't built all the features that were necessary for your project to work sufficiently when you're presenting it in front
...
var game = {
  scenarioList: [accountabilityGroup, fridayFeels, coffeeBreak, crisis],
  player: george
}
var refreshScreen = function() {
  $('#scenarioText').html(game.scenarioList[scenCount].getScenarioText())
  $('#buttonOption1').html(game.scenarioList[scenCount].getGoodDecisionText())
  $('#buttonOption2').html(game.scenarioList[scenCount].getBadDecisionText())
}

$('#scenarioText').html(game.scenarioList[scenCount].getScenarioText())

$('#buttonOption1').html(game.scenarioList[scenCount].getGoodDecisionText())
$('#buttonOption1').click(function() {
  scenCount++
  console.log(scenCount)
  game.player.increasePosCount()
...
$('#buttonOption2').html(game.scenarioList[scenCount].getBadDecisionText())
$('#buttonOption2').click(function() {
  scenCount++
  console.log(scenCount)
  game.player.increaseNegCount()
  game.player.saveDecision()
  refreshScreen()
  })
